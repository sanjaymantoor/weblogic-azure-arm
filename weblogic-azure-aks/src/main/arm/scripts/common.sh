...
export gitUrl4AksToolingWellTestedVersionJsonFile="https://raw.githubusercontent.com/galiacheng/weblogic-azure/haiche-wls-autoscaling/weblogic-azure-aks/src/main/resources/aks_tooling_well_tested_version.json"
