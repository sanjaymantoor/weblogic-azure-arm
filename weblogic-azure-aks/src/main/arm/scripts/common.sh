...
export gitUrl4WLSToolingFamilyJsonFile="https://github.com/galiacheng/weblogic-azure/raw/wls-autoscaling-0131/weblogic-azure-aks/src/main/resources/weblogic_tooling_family.json"
